...
Imagine que foi pedido a você para fazer uma aplicação em que em base de uma entrada se busca um pokémon pelo nome.
...
- Uma tela com um input que aceite uma entrada de texto
- Um botão com o texto 'buscar'
- Ao clicar em buscar se procura pelo pokémon na base
- Se houver um pokémon é mostrado o nome e imagem desse pokémon.
- Se não houver um pokémon indique pro usuário através de uma mensagem na tela.
...
- ReactJs
- fazer deploy
- utilizar a [pokeapi](https://pokeapi.co)
...
- Usar typeScript
- Se adicionar a visualização de mais campos além de nome e imagem no retorno de um pokémon encontrado.
